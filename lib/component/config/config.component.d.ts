...
export declare class ConfigDisplayComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ConfigDisplayComponent, "app-config-display", never, { "cols": { "alias": "cols"; "required": false; }; }, { "onChangeConfig": "onChangeConfig"; }, never, never, true, never>;
}
