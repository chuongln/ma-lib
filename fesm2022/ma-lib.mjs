...
import { Injectable, Inject, Component, Directive, Input, Pipe, NgModule, EventEmitter, Output, ContentChild, ViewChild, forwardRef, Optional } from '@angular/core';
...
class ViewSvgComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: ViewSvgComponent, deps: [{ token: MaService }, { token: i2$1.DomSanitizer }], target: i0.ɵɵFactoryTarget.Component }); }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: ViewSvgComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: MaService }, { type: i2$1.DomSanitizer }]; }, propDecorators: { name: [{
                type: Input
            }] } });
    ...
    executeSearch() {
        ...
        for (const key in searchParams) {
            if (searchParams[key] instanceof Date) {
                searchParams[key] = this.maService.modifyDateByUTC(searchParams[key]).toISOString();
            }
            if (key == 'dateRange' && searchParams[key].length == 2) {
                if (searchParams[key][0]) {
                    searchParams[key][0] = this.maService.modifyDateByUTC(new Date(searchParams[key][0])).toISOString();
                }
                if (searchParams[key][1]) {
                    searchParams[key][1] = this.maService.modifyDateByUTC(new Date(searchParams[key][1])).toISOString();
                }
            }
        }
        if (this.getList$) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: TableComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: MaService }]; }, propDecorators: { datas: [{
                type: Input
            }], havePaginator: [{
                type: Input
            }], cols: [{
...
class DatePickerComponent extends BaseControlValueAccessor {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: DatePickerComponent, deps: [{ token: i1$3.ControlContainer, optional: true }], target: i0.ɵɵFactoryTarget.Component }); }
...
class FiltersComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: FiltersComponent, deps: [{ token: i1$2.TranslateService }], target: i0.ɵɵFactoryTarget.Component }); }
...
class ControlComponent extends BaseControlValueAccessor {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: ControlComponent, deps: [{ token: i1$3.ControlContainer, optional: true }], target: i0.ɵɵFactoryTarget.Component }); }
