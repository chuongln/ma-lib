...
import { Injectable, Component, Directive, Input, Pipe, Inject, NgModule, EventEmitter, Output, ContentChild, ViewChild, forwardRef, Optional } from '@angular/core';
...
class DatePickerComponent extends BaseControlValueAccessor {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: DatePickerComponent, deps: [{ token: i1$4.ControlContainer, optional: true }], target: i0.ɵɵFactoryTarget.Component }); }
